...
# def test_employee_full_name(pers):
#     assert pers.full_name() == "Ivanov Ivan Ivanovich"

# def test_employee_birthday(pers):
#     pers.birthday()
#     assert pers.get_age() == 31

# def test_employee_raise_salary(pers):
#     pers.raise_salary(10)
#     assert pers.salary == 55000

# def test_employee_str(pers):
#     assert str(pers) == "Ivanov Ivan Ivanovich (Manager)"

# def test_employee_last_name_title(pers):
#     assert pers.last_name == "Ivanov"
