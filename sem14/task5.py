...
class TestEmployee(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.pers = Employee("ivanov", "ivan", "ivanovich", 30, "manager", 50000)

    def test_employee_full_name(self):
        self.assertEqual(self.pers.full_name(), "Ivanov Ivan Ivanovich")

    def test_employee_birthday(self):
        self.pers.birthday()
        self.assertEqual(self.pers.get_age(), 31)

    def test_employee_raise_salary(self):
        self.pers.raise_salary(10)
        self.assertEqual(self.pers.salary, 55000)

    def test_employee_str(self):
        self.assertEqual(str(self.pers), "Ivanov Ivan Ivanovich (Manager)")

    def test_employee_last_name_title(self):
        self.assertNotEqual(self.pers.last_name, "Ivan")
